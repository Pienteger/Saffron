...
namespace SaffronML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\MahmudulHasan\Downloads\archive (1)\Twitter_Data.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("category", "category")
                                      .Append(mlContext.Transforms.Text.FeaturizeText("clean_text_tf", "clean_text"))
                                      .Append(mlContext.Transforms.CopyColumns("Features", "clean_text_tf"));
